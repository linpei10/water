...
def excel2json(inputFilePath, outputFilePath):
    ...
    for i in range(nrows):
        ...
        for j in range(ncols):
            ...
            if (title_cn == "化学需氧量" or title_cn == "氨氮" or
                title_cn == "总磷" or title_cn == "高猛酸盐指数" or
                title_cn == "溶解氧" or title_cn == "pH" or
                title_cn == "水温" or title_cn == "电导率"):
...
if __name__ == "__main__":
    excel2json("断面小时数据.xlsx","断面小时数据.json")