  ...
  <div class="page index">
    ...
    <div class="panel left">
      <div class="dtable dtable-pwk">
        <h3 class="h3l">排污口实时污染物浓度 <span class="h3ldesc">mg/L，仿真用</span></h3>
        <div class="tablehead">
          <span class="data head">TN</span>
          <span class="data head">CODcr</span>
          ...
          <li>
            <div class="item">
              ...
              <div class="line line1">
                ...
                <span class="data data2">{{(typeof dataItem.codcr)=="number"?dataItem.codcr.toFixed(2):dataItem.codcr}}</span>
                ...
                <span class="data data2">{{dataItem.codcr instanceof Number?dataItem.codcr.toFixed(3):dataItem.codcr}}</span>
      ...
      <div class="dtable dtable-sz">
        <h3 class="h3l">水质监测站 <span class="h3ldesc">污染物浓度，仿真用</span></h3>
        <div class="tablehead">
          ...
          <li>
            <div class="item">
              <div class="line line1">
                ...
                <span class="data data1">{{dataItem.CODCR instanceof Number?dataItem.CODCR.toFixed(3):dataItem.CODCR}}</span>
    ...
    <div class="panel right">
      <div class="rvideo">
        ...
        <video width="320" height="240" controls autoplay preload muted loop>
          <source src="uploads/index/流域俯视视频.mp4" type="video/mp4">
          Your browser does not support the video tag.
        </video>
      </div>
      <div class="dtable dlist dlist-dm">
        <h3 class="h3l">各仿真监测站水质等级 <span class="h3ldesc">时间变化曲线</span></h3>
        <ul>
          <li v-for="n in 6" v-bind:key="n+'sz'">
            <div class="item" :class="isMouseover(n-1)"
              ...
              <img
                class="graph"
                :src="'uploads/index/right/断面'+ n +'水质曲线.png'"
              />
              <div class="action">
    ...
    <div class="panelwide bottom">
      <div class="sec-qsz">
        ...
        <div class="graph graph-qsz">
          ...
          >
            <span class="t">{{waterQuality[0]}}<span class="p">截面1</span></span>
          </div>
          ...
          <div
            ...
            style="width: calc(0.166*10*4rem)"
          >
            <span class="t">{{waterQuality[1]}}<span class="p">截面2</span></span>
          </div>
          ...
          <div
            ...
            style="width: calc(0.166*10*4rem)"
          >
            <span class="t">{{waterQuality[2]}}<span class="p">截面3</span></span>
          </div>
          ...
          <div
            ...
            style="width: calc(0.166*10*4rem)"
          >
            <span class="t">{{waterQuality[3]}}<span class="p">截面4</span></span>
          </div>
          ...
          <div
            ...
            style="width: calc(0.166*10*4rem)"
          >
            <span class="t">{{waterQuality[4]}}<span class="p">截面5</span></span>
          </div>
          ...
          <div
            ...
            style="width: calc(0.166*10*4rem)"
          >
            <span class="t">{{waterQuality[5]}}<span class="p">截面6</span></span>
          </div>
      ...
      <div class="sec-qpollute">
        <h3>全流域污染物含量平均值 <span class="h3ldesc">mg/L，仿真</span></h3>
...
export default {
  ...
  data() {
    return {
      ...
      waterQuality: ['Ⅳ类', 'Ⅳ类', 'Ⅳ类', 'Ⅳ类', 'Ⅳ类', 'Ⅱ类'],
    };
  },
